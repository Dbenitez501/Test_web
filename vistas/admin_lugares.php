...
<html>
    ...
    <body>
        ...
        <div class="tablas_seccion_conferencias">
                ...
                <a href="lugares_nuevo.php"><input type="submit" value="Nuevo" class="boton_nuevo"></a>
                </div>
                <br>
                <div class="table-responsive">
                <table id="example3" class="table_p_admin">
                    <thead>    
                        <tr>
                            <th>Id</th>
                            <th>Nombre</th>
                    ...
                    <tr> 
                        ...
                        <td data-label="Ubicación"><?php echo $data["ubicacion"];?></td>
                        <td data-label="Capacidad Máxima"><?php echo $data["capacidad_max"];?></td>
                        <td data-label="Descripción"><?php echo $data["descripcion"];?></td>
                        <td data-label="Estado"><?php echo $data["estado"];?></td>
                        <td data-label="Botones"><a href='mod_conf_l.php?id=<?php echo $id?>'><input type="submit" value="Modificar" class="boton_mod"></a><!-- <a href='#' onclick="preguntar(<?php echo $id?>)"><input type="submit" value="Eliminar" id="btnEliminar" class="boton_elim"></a> --></td>
                    </tr>
                    <?php
                        }
                    }
        ...
        <script type="text/javascript">
            ...
            function preguntar(id) {
                swal({
                    title: "Confirmación",
                    text: "¿Seguro que quieres eliminar el lugar?", 
                    icon: "warning",
                    dangerMode: true,
                    buttons: {
                        cancel: {
