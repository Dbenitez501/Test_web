        ...
        <section class="inicio-sesion">
            <div class="row row-sesion">
                <div class="sesion-col">
                    <h2 style="color:#fff;">Opciones de filtrado</h2>
                    <hr>
                    <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="fas fa-chalkboard-teacher"></i>
                        </div>
                        <a class="link" href="filtrado_conferencia.php">Conferencia</a>
                    </div>
                    <!-- <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="fas fa-user-alt icon"></i>
                        </div>
                        <a class="link" href="#">Persona</a>
                    </div> -->
                    <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="far fa-calendar-alt icon"></i>
                        </div>
                        <a class="link" href="filtrado_fecha.php">Fechas</a>
                    </div>
                    <div class="usuario-container">
                        <div class="usuario-icon">
