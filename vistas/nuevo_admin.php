        ...
        <section class="registro-usuario">
            <div class="row row-registro">
                <div class="registro-col">
                    <h2 style="color:#fff;">Nuevo Administrador</h2>
                    <hr>
                    <form class="registro-form" action="../include/registrarAdmin.php" target="" method="POST" name="formAdmin" onsubmit="return validar();">
                    <?php
                    $sexo = "";
                    $tipo = "";
                    ?>
                        ...
                        <div class="btn-container">
                            <input type="submit" value="Registrar" name="enviar_admin" class="registro-btn">
                        </div>
                    </form>
                </div>
