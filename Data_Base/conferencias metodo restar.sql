...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2022 a las 04:26:35
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `restar_capacidad_presencial` (IN `id_r` INT, IN `fecha_actual` DATE)  BEGIN
DECLARE cap_act INT;
DECLARE cap_maxima INT;
DECLARE id_p INT;
...
END IF;
/*Intentar desactivar si es despues de la hora marcada del dia*/
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `restar_capacidad_virtual` (IN `id_r` INT, IN `fecha_actual` DATE)  BEGIN
DECLARE cap_act INT;
DECLARE cap_maxima INT;
DECLARE id_v INT;
DECLARE fecha_conferencia DATE;
...
(10, 'Conferencia FASTENAL Prueba', 'Conferencia llevada a cabo por la empresa FASTENAL', 'Expositor 1', '2021-06-30', '11:00', 1, 1, 6, 'fastenal432', 'Presencial', 0x3738323136372e6a7067, '2022-02-28 20:34:02'),
(22, 'Conferencia de Cemex', 'Aquí va la descripción de la conferencia ', 'Ing. Cemex', '2022-02-03', '17:30', 1, 1, 6, '822189', 'Presencial', 0x3834323432362e6a7067, '2022-02-28 20:34:15');
...
(9, 'Impacto de empresas de consumo masivo', 'Impacto de empresas de consumo masivo en generación de riqueza, empleo y nuevas tecnologías en países emergentes', 'ING. JOSE LUIS PEREZ RENTERIA', '2022-03-08', '17:00', 'MsTeams', 'a8gf345', 1, 0, 50, 'arca345', 'Virtual', 0x3839323839342e706e67, '2021-07-02 21:04:45'),
...
--
ALTER TABLE `registros`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT COMMENT 'identificador único del registro', AUTO_INCREMENT=109;
