        ...
        <section class="inicio-sesion">
            <div class="row row-sesion">
                <div class="sesion-col">
                    ...
                    <h2 style="color:#fff;">Bienvenido/a <br><h3><?php
                        if(isset($_SESSION['user'])) {
                        echo $user->getNombre();
                        echo "<br>";
                        echo $user->getTipo();
                    ...
                    <div class="usuario-container">
                        ...
                        <a class="link" href="vistas/menu_tipo.php">Conferencias</a>
                    </div>
                    <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="fas fa-map-marker-alt icon"></i>
                        </div>
                        <a class="link" href="vistas/admin_lugares.php">Lugares</a>
                    </div>
                    <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="far fa-clipboard icon"></i>
                        </div>
                        <a class="link" href="vistas/menu_filtrado.php">Reportes</a>
                    </div>
                    <div class="usuario-container">
                        <div class="usuario-icon">
                            <i class="fas fa-plus icon"></i>
                        </div>
                        <a class="link" href="vistas/administradores.php">Administración</a>
                    </div>
                </div>
